...
(function() {
  const SUPABASE_URL = 'http://10.0.0.106:8080';
  ...
  window.db = {
    ...
    // ─── Realtime Subscriptions (disabled for on-premises) ──
    subscribeToRepairOrders(callback) {
      console.log('On-premises: Realtime disabled');
      return { unsubscribe: () => {} };
    },
  ...
  console.log('Supabase connected to Glass Aero Production Tracking (On-Premises)');
})();
